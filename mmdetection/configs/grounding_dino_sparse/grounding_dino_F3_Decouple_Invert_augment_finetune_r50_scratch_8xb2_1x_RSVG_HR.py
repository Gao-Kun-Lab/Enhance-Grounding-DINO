...
load_from = "WORK_DIR/mmdetection/work_dirs/grounding_dino_F3_Decouple_Invert_augment_r50_scratch_8xb2_1x_RSVG/epoch_12.pth"
...
train_pipeline = [
    ...
    dict(
        ...
        scales=[(768, 768), (840, 840), (920, 920), (1024, 1024), ],
        keep_ratio=True),
