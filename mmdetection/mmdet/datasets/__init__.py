...
from .SODA_A import SODAADataset
from .RSVG import RSVGDataset
from .rrsisd import rrsisdDataset
from .RSVG_HR import RSVG_HRDataset
from .Sentinel import Sentinel2Dataset
from .Sentinel_VG import SentinelVGDataset
...
__all__ = [
    ...
    'DOTADataset', 'SODAADataset', 'RSVGDataset', 'rrsisdDataset', 'RSVG_HRDataset',
    'Sentinel2Dataset', 'SentinelVGDataset'
]
