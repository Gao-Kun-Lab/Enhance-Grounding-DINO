...
class rrsisdDataset(BaseDataset):
    """rrsisd dataset.
    ...
    METAINFO = {
        'classes':
            ('chimney', 'airplane', 'trainstation', 'airport', 'Expressway toll station', 'harbor',
             'groundtrackfield', 'overpass', 'windmill', 'stadium', 'basketballcourt', 'baseballfield',
            'bridge', 'tenniscourt', 'ship', 'dam', 'vehicle', 'storagetank', 'golffield', 'Expressway Service area'),
    ...
    def load_data_list(self) -> List[dict]:
        ...
        ref_ids = [
            ref['ref_id'] for ref in self.splits if ref['split'] in self.split
        ]
        full_anno = []
        ...
        for image in images:
            ...
            for grounding_anno in grounding_dict[img_id]:
                ...
                ins = [{
                    ...
                    'bbox_label': grounding_anno['categories_id'],
                    'ignore_flag': 0
                }] * len(text)
