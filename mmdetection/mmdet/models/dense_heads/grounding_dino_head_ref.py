...
class GroundingDINOHead_ref(DINOHead):
    ...
    def _predict_by_feat_single(self,
        ...
        # cls_score_out = scores[scores > 0.05]
        # bbox_pred = bbox_pred[scores > 0.05, :]
        # det_labels = det_labels[scores > 0.05]
