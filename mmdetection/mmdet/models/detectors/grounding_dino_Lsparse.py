...
from ..layers.transformer.grounding_dino_sparse_layers import (
    GroundingDinoLSparseTransformerEncoder
)
...
class GroundingDINO_L_sparse(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoLSparseTransformerEncoder(**self.encoder)
    ...
    def pre_decoder(
        ...
        label_inds = torch.tensor(label_inds, device=query.device)
        text_token_mask_sparse = text_token_mask[:, label_inds]
        ...
        decoder_inputs_dict = dict(
            ...
            dn_mask=dn_mask,
            memory_text=memory_text_sparse,
            text_attention_mask=~text_token_mask_sparse,
        )
