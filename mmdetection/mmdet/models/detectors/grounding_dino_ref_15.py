...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder_15)
...
class GroundingDINO_ref_15(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoTransformerEncoder_15(**self.encoder)
