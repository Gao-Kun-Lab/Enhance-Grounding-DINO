...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoAttnGuideTransformerEncoder)
...
class GroundingDINO_ref_Attn(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoAttnGuideTransformerEncoder(**self.encoder)
