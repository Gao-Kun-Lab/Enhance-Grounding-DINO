...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoLQVGTransformerEncoder)
...
class GroundingDINO_ref_LQVG(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoLQVGTransformerEncoder(**self.encoder)
        ...
        if self.show_feature:
            ...
            for i in range(bs):
                ...
                for layer in range(len(self.activations)):
                    ...
                    with open(osp.join(output_dir, 'gt_bg_delta_LQVG.txt'), 'a') as f:
                        f.write(out_str + '\n')
                if show:
