...
from ..layers.transformer.grounding_dino_sparse_layers import GroundingDinoLadaptTransformerDecoder
...
class GroundingDINO_ref_Ladapt(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.decoder = GroundingDinoLadaptTransformerDecoder(**self.decoder)
    ...
    def forward_decoder(self,
        ...
        """
        inter_states, inter_states_lang, references = self.decoder(
            query=query,
            value=memory,
        ...
        if self.training:
            decoder_outputs_dict = dict(
                hidden_states=inter_states, hidden_states_lang=inter_states_lang, references=list(references))
        else:
            decoder_outputs_dict = dict(
