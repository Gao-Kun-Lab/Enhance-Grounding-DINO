...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoUTransformerEncoder)
...
class GroundingDINO_ref_U(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoUTransformerEncoder(**self.encoder)
