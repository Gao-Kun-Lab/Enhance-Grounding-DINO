...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoUFusionTransformerEncoder)
...
class GroundingDINO_ref_U_Fusion(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoUFusionTransformerEncoder(**self.encoder)
