...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoUDecoupleTransformerEncoder)
...
class GroundingDINO_ref_U_decouple(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoUDecoupleTransformerEncoder(**self.encoder)
