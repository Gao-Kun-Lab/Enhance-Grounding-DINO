...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoAblationTransformerEncoder)
...
class GroundingDINO_ref_ablation_sparse(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoAblationTransformerEncoder(**self.encoder)
