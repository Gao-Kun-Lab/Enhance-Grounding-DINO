...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoDecoupleEncTransformerEncoder)
...
class GroundingDINO_ref_decouple_enc(DINO):
    ...
    def __init__(self, language_model, show_feature=False, *args, **kwargs) -> None:
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoDecoupleEncTransformerEncoder(**self.encoder)
            ...
            for i in range(bs):
                ...
                for layer in range(len(self.activations)):
                    ...
                    for level, vf in enumerate(visual_feats):
                        ...
                        delta = pred_cam.mean() - bg_cam.mean()
                    ...
                    # output_dir = 'WORK_DIR/mmdetection/work_dirs/RSVG_out_imshow/'
                    # with open(osp.join(output_dir, 'pred_bg_delta_base.txt'), 'a') as f:
                    #     f.write(out_str + '\n')
                if show:
