...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoCAMFPNTransformerEncoder)
...
class GroundingDINO_ref_decouple_fpn(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoCAMFPNTransformerEncoder(**self.encoder)
