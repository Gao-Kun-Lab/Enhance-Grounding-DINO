...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoDecoupleInvertBlockTransformerEncoder)
...
class GroundingDINO_ref_decouple_invert_block(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoDecoupleInvertBlockTransformerEncoder(**self.encoder)
