...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoDecoupleLinearTransformerEncoder)
...
class GroundingDINO_ref_fusion_linear(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoDecoupleLinearTransformerEncoder(**self.encoder)
