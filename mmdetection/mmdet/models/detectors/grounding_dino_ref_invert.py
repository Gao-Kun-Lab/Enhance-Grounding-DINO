...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoInvertTransformerEncoder)
...
class GroundingDINO_ref_invert(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoInvertTransformerEncoder(**self.encoder)
