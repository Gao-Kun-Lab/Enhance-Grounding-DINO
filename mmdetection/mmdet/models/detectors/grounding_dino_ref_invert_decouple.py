...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoInvertDecoupleTransformerEncoder)
...
class GroundingDINO_ref_invert_decouple(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoInvertDecoupleTransformerEncoder(**self.encoder)
