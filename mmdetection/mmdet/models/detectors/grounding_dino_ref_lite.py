...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoLiteTransformerEncoder)
...
class GroundingDINO_ref_lite(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoLiteTransformerEncoder(**self.encoder)
