...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoMidGuideTransformerEncoder)
...
class GroundingDINO_ref_mid_guide(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoMidGuideTransformerEncoder(**self.encoder)
