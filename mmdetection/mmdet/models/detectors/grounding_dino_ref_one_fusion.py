...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoOneFusionTransformerEncoder)
...
class GroundingDINO_ref_one_fusion(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoOneFusionTransformerEncoder(**self.encoder)
