...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoStage2TransformerEncoder)
...
class GroundingDINO_ref_stage3(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoStage2TransformerEncoder(**self.encoder)
