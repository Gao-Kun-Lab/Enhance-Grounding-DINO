...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoStage2DecoupleTransformerEncoder)
...
class GroundingDINO_ref_stage3_decouple(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoStage2DecoupleTransformerEncoder(**self.encoder)
