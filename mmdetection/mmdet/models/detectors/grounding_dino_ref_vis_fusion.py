...
from ..layers.transformer.grounding_dino_layers import (
    GroundingDinoTransformerDecoder, GroundingDinoTransformerEncoder, GroundingDinoVisTransformerEncoder)
...
class GroundingDINO_ref_vis_fusion(DINO):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = GroundingDinoVisTransformerEncoder(**self.encoder)
