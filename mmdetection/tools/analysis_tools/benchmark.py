...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path',
                        # default='../../configs/grounding_dino_sparse/grounding_dino_F3_Decouple_Invert_noguide_r50_scratch_8xb2_1x_RSVG.py'
                        default='../../configs/grounding_dino/grounding_dino_fusion_decouple_IoU_match_r50_scratch_8xb2_1x_RSVG_HR.py'
    ...
    parser.add_argument('--checkpoint', help='checkpoint file',
                        # default='../../work_dirs/grounding_dino_F3_Decouple_Invert_noguide_r50_scratch_8xb2_1x_RSVG/epoch_12.pth'
                        default='../../work_dirs/grounding_dino_fusion_decouple_IoU_match_r50_scratch_8xb2_1x_RSVG_HR/epoch_12.pth'
                        # default='../../work_dirs/grounding_dino_r50_scratch_8xb2_1x_RSVG/epoch_12.pth'
                        # default='../../work_dirs/grounding_dino_F3_Decouple_Invert_25_r50_scratch_8xb2_1x_RSVG/epoch_12.pth'
                        )
    parser.add_argument(
        '--work-dir',
        # default='../../work_dirs/grounding_dino_F3_Decouple_Invert_012345_r50_scratch_8xb2_1x_RSVG/',
