...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',
                        ...
                        # default='../../configs/grounding_dino/grounding_dino_fusion_decouple_r50_scratch_8xb2_1x_RSVG_HR.py')
                        # default='../../configs/grounding_dino/grounding_dino_fusion_decouple_IoU_match_r50_scratch_8xb2_1x_RSVG.py')
                        # default='../../configs/retinanet/retinanet_r50_fpn_1x_DOTA.py')
                        # default='../../configs/dab_detr/dab-detr_r50_8xb2-50e_DOTA.py')
                        # default='../../configs/dino/dino-4scale_r50_8xb2-12e_DOTA.py')
                        # default='../../configs/dynamic_rcnn/dynamic-rcnn_r50_fpn_1x_DOTA.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_decouple_text_single_r50_scratch_8xb2_1x_RSVG.py')
                        default='../../configs/grounding_dino/grounding_dino_fusion_decouple_IoU_match_r50_scratch_8xb2_1x_DOTA.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_U_Fusion_r50_scratch_8xb2_1x_DOTA.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_F3_Decouple_Invert_r50_scratch_8xb2_1x_DOTA.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_15_r50_scratch_8xb2_1x_RSVG.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_F3_H_r50_scratch_8xb2_1x_DOTA.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_fusion_decouple_guide_r50_scratch_8xb2_1x_RSVG_HR.py')
                        # default='../../configs/deformable_detr/deformable-detr_r50_16xb2-50e_DOTA.py')
                        ...
                        # default='../../configs/grounding_dino_sparse/grounding_dino_r50_scratch_8xb2_1x_RSVG_HR.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_lite_r50_scratch_8xb2_1x_RSVG_HR.py')
                        # default='../../configs/grounding_dino/grounding_dino_fusion_decouple_IoU_match_r50_scratch_8xb2_1x_RSVG.py')
    parser.add_argument(
        '--num-images',
        type=int,
...
def inference(args, logger):
    ...
    print('flops:{}G'.format(int(np.average(avg_flops)) / 1e9))
