...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path',
                        ...
                        default='../../configs/grounding_dino_sparse/grounding_dino_F3_Decouple_Invert_block1_r50_scratch_8xb2_1x_RSVG_HR.py')
                        # default='../../configs/grounding_dino_sparse/grounding_dino_15_r50_scratch_8xb2_1x_RSVG_HR.py')
